...
### typecheck AnnotationsAndInstance592.tla

```sh
$ apalache-mc typecheck AnnotationsAndInstance592.tla | sed 's/[IEW]@.*//'
...
PASS #1: TypeChecker
 > Running Snowcat .::.
 > Your types are great!
...
### typecheck AnnotationsAndInstance596.tla

```sh
$ apalache-mc typecheck AnnotationsAndInstance596.tla | sed 's/[IEW]@.*//'
...
PASS #1: TypeChecker
 > Running Snowcat .::.
 > Your types are great!
