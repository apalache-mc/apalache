...
```sh
$ APALACHE_PKG_INFO=true JVM_ARGS="-Xms1m -XX:+UseSerialGC" apalache-mc version | sed 's/-DTLA-Library.*//'
...
...
```sh
$ APALACHE_PKG_INFO=true JVM_ARGS="-Xmx16m" apalache-mc version | sed 's/-DTLA-Library.*//'
...
# JVM args: -Xmx16m
...
```
