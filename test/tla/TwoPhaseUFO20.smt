...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; frame 16
(declare-fun rmWorking_16 (RM) Bool)
(declare-fun rmPrepared_16 (RM) Bool)
(declare-fun rmCommitted_16 (RM) Bool)
(declare-fun rmAborted_16 (RM) Bool)
(declare-fun sentPrepared_16 (RM) Bool)
(declare-fun tmState_16 () TMState)

(declare-fun action_16 () Action)

; actions for frame 16
(assert (=> (= action_16 TMRcvPrepared) (and
    (= tmState_15 TMinit)
    ;; the line below gives us unknown:
    ;;(= rmWorking_16 rmWorking_15)
    (forall ((rm RM)) (= (rmWorking_16 rm) (rmWorking_15 rm)))
    (forall ((rm RM)) (= (rmPrepared_16 rm) (rmPrepared_15 rm)))
    (forall ((rm RM)) (= (rmCommitted_16 rm) (rmCommitted_15 rm)))
    (forall ((rm RM)) (= (rmAborted_16 rm) (rmAborted_15 rm)))
    (forall ((rm RM)) (= (sentPrepared_16 rm) (sentPrepared_15 rm)))
    (= tmState_16 tmState_15)
))) ;;;

(assert (=> (= action_16 TMCommit) (and
    (= tmState_15 TMinit)
    (forall ((rm RM)) (sentPrepared_15 rm))
    (= tmState_16 TMcommitted)
    (forall ((rm RM)) (= (rmWorking_16 rm) (rmWorking_15 rm)))
    (forall ((rm RM)) (= (rmPrepared_16 rm) (rmPrepared_15 rm)))
    (forall ((rm RM)) (= (rmCommitted_16 rm) (rmCommitted_15 rm)))
    (forall ((rm RM)) (= (rmAborted_16 rm) (rmAborted_15 rm)))
...
(assert (=> (= action_16 TMAbort) (and
    (= tmState_15 TMinit)
    (= tmState_16 TMaborted)
    (forall ((rm RM)) (= (rmWorking_16 rm) (rmWorking_15 rm)))
    (forall ((rm RM)) (= (rmPrepared_16 rm) (rmPrepared_15 rm)))
    (forall ((rm RM)) (= (rmCommitted_16 rm) (rmCommitted_15 rm)))
    (forall ((rm RM)) (= (rmAborted_16 rm) (rmAborted_15 rm)))
...
(assert (=> (= action_16 RMPrepare)
    (exists ((rm RM)) (and
        ...
        (forall ((rm2 RM))
            (or
              (= rm rm2)
              (= (rmWorking_16 rm2) (rmWorking_15 rm2)))
            ) ;;;
        (rmPrepared_16 rm)
        (forall ((rm2 RM))
            (or
              (= rm rm2)
              (= (rmPrepared_16 rm2) (rmPrepared_15 rm2)))
            ) ;;;
        (forall ((rm2 RM))
            (or
              (= rm rm2)
              (= (sentPrepared_16 rm2) (sentPrepared_15 rm2)))
            ) ;;;
        (forall ((rm2 RM)) (= (rmCommitted_16 rm2) (rmCommitted_15 rm2)))
        (forall ((rm2 RM)) (= (rmAborted_16 rm2) (rmAborted_15 rm2)))
        (= tmState_16 tmState_15)
)))) ;;;

(assert (=> (= action_16 RMChooseToAbort)
    (exists ((rm RM)) (and
        (rmWorking_15 rm)
        (not (rmWorking_16 rm))
        (forall ((rm2 RM))
        ...
        (forall ((rm2 RM))
            (or
              (= rm rm2)
              (= (rmAborted_16 rm2) (rmAborted_15 rm2)))
            ) ;;;
        (forall ((rm2 RM)) (= (rmCommitted_16 rm2) (rmCommitted_15 rm2)))
        (forall ((rm2 RM)) (= (sentPrepared_16 rm2) (sentPrepared_15 rm2)))
        (= tmState_16 tmState_15)
)))) ;;;

(assert (=> (= action_16 RMRcvCommitMsg)
    (exists ((rm RM)) (and
        (= tmState_15 TMcommitted)
        (not (rmWorking_16 rm))
        (forall ((rm2 RM))
        ...
        (forall ((rm2 RM))
            (or
              (= rm rm2)
              (= (rmCommitted_16 rm2) (rmCommitted_15 rm2)))
            ) ;;;
        (not (rmAborted_16 rm))
        (forall ((rm2 RM))
            (or
...
(assert (=> (= action_16 RMRcvAbortMsg)
    (exists ((rm RM)) (and
        (= tmState_15 TMaborted)
        (not (rmWorking_16 rm))
        (forall ((rm2 RM))
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; frame 17
(declare-fun rmWorking_17 (RM) Bool)
(declare-fun rmPrepared_17 (RM) Bool)
(declare-fun rmCommitted_17 (RM) Bool)
(declare-fun rmAborted_17 (RM) Bool)
(declare-fun sentPrepared_17 (RM) Bool)
(declare-fun tmState_17 () TMState)

(declare-fun action_17 () Action)

; actions for frame 17
(assert (=> (= action_17 TMRcvPrepared) (and
    (= tmState_16 TMinit)
    ;; the line below gives us unknown:
    ;;(= rmWorking_17 rmWorking_16)
    (forall ((rm RM)) (= (rmWorking_17 rm) (rmWorking_16 rm)))
    (forall ((rm RM)) (= (rmPrepared_17 rm) (rmPrepared_16 rm)))
    (forall ((rm RM)) (= (rmCommitted_17 rm) (rmCommitted_16 rm)))
    (forall ((rm RM)) (= (rmAborted_17 rm) (rmAborted_16 rm)))
    (forall ((rm RM)) (= (sentPrepared_17 rm) (sentPrepared_16 rm)))
    (= tmState_17 tmState_16)
))) ;;;

(assert (=> (= action_17 TMCommit) (and
    (= tmState_16 TMinit)
    (forall ((rm RM)) (sentPrepared_16 rm))
    (= tmState_17 TMcommitted)
    (forall ((rm RM)) (= (rmWorking_17 rm) (rmWorking_16 rm)))
    (forall ((rm RM)) (= (rmPrepared_17 rm) (rmPrepared_16 rm)))
    (forall ((rm RM)) (= (rmCommitted_17 rm) (rmCommitted_16 rm)))
    (forall ((rm RM)) (= (rmAborted_17 rm) (rmAborted_16 rm)))
...
(assert (=> (= action_17 TMAbort) (and
    (= tmState_16 TMinit)
    (= tmState_17 TMaborted)
    (forall ((rm RM)) (= (rmWorking_17 rm) (rmWorking_16 rm)))
    (forall ((rm RM)) (= (rmPrepared_17 rm) (rmPrepared_16 rm)))
    (forall ((rm RM)) (= (rmCommitted_17 rm) (rmCommitted_16 rm)))
    (forall ((rm RM)) (= (rmAborted_17 rm) (rmAborted_16 rm)))
...
(assert (=> (= action_17 RMPrepare)
    (exists ((rm RM)) (and
        ...
        (forall ((rm2 RM))
            (or
              (= rm rm2)
              (= (rmWorking_17 rm2) (rmWorking_16 rm2)))
            ) ;;;
        (rmPrepared_17 rm)
        (forall ((rm2 RM))
            (or
              (= rm rm2)
              (= (rmPrepared_17 rm2) (rmPrepared_16 rm2)))
            ) ;;;
        (forall ((rm2 RM))
            (or
              (= rm rm2)
              (= (sentPrepared_17 rm2) (sentPrepared_16 rm2)))
            ) ;;;
        (forall ((rm2 RM)) (= (rmCommitted_17 rm2) (rmCommitted_16 rm2)))
        (forall ((rm2 RM)) (= (rmAborted_17 rm2) (rmAborted_16 rm2)))
        (= tmState_17 tmState_16)
)))) ;;;

(assert (=> (= action_17 RMChooseToAbort)
    (exists ((rm RM)) (and
        (rmWorking_16 rm)
        (not (rmWorking_17 rm))
        (forall ((rm2 RM))
        ...
        (forall ((rm2 RM))
            (or
              (= rm rm2)
              (= (rmAborted_17 rm2) (rmAborted_16 rm2)))
            ) ;;;
        (forall ((rm2 RM)) (= (rmCommitted_17 rm2) (rmCommitted_16 rm2)))
        (forall ((rm2 RM)) (= (sentPrepared_17 rm2) (sentPrepared_16 rm2)))
        (= tmState_17 tmState_16)
)))) ;;;

(assert (=> (= action_17 RMRcvCommitMsg)
    (exists ((rm RM)) (and
        (= tmState_16 TMcommitted)
        (not (rmWorking_17 rm))
        (forall ((rm2 RM))
        ...
        (forall ((rm2 RM))
            (or
              (= rm rm2)
              (= (rmCommitted_17 rm2) (rmCommitted_16 rm2)))
            ) ;;;
        (not (rmAborted_17 rm))
        (forall ((rm2 RM))
            (or
...
(assert (=> (= action_17 RMRcvAbortMsg)
    (exists ((rm RM)) (and
        (= tmState_16 TMaborted)
        (not (rmWorking_17 rm))
        (forall ((rm2 RM))
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; frame 18
(declare-fun rmWorking_18 (RM) Bool)
(declare-fun rmPrepared_18 (RM) Bool)
(declare-fun rmCommitted_18 (RM) Bool)
(declare-fun rmAborted_18 (RM) Bool)
(declare-fun sentPrepared_18 (RM) Bool)
(declare-fun tmState_18 () TMState)

(declare-fun action_18 () Action)

; actions for frame 18
(assert (=> (= action_18 TMRcvPrepared) (and
    (= tmState_17 TMinit)
    ;; the line below gives us unknown:
    ;;(= rmWorking_18 rmWorking_17)
    (forall ((rm RM)) (= (rmWorking_18 rm) (rmWorking_17 rm)))
    (forall ((rm RM)) (= (rmPrepared_18 rm) (rmPrepared_17 rm)))
    (forall ((rm RM)) (= (rmCommitted_18 rm) (rmCommitted_17 rm)))
    (forall ((rm RM)) (= (rmAborted_18 rm) (rmAborted_17 rm)))
    (forall ((rm RM)) (= (sentPrepared_18 rm) (sentPrepared_17 rm)))
    (= tmState_18 tmState_17)
))) ;;;

(assert (=> (= action_18 TMCommit) (and
    (= tmState_17 TMinit)
    (forall ((rm RM)) (sentPrepared_17 rm))
    (= tmState_18 TMcommitted)
    (forall ((rm RM)) (= (rmWorking_18 rm) (rmWorking_17 rm)))
    (forall ((rm RM)) (= (rmPrepared_18 rm) (rmPrepared_17 rm)))
    (forall ((rm RM)) (= (rmCommitted_18 rm) (rmCommitted_17 rm)))
    (forall ((rm RM)) (= (rmAborted_18 rm) (rmAborted_17 rm)))
...
(assert (=> (= action_18 TMAbort) (and
    (= tmState_17 TMinit)
    (= tmState_18 TMaborted)
    (forall ((rm RM)) (= (rmWorking_18 rm) (rmWorking_17 rm)))
    (forall ((rm RM)) (= (rmPrepared_18 rm) (rmPrepared_17 rm)))
    (forall ((rm RM)) (= (rmCommitted_18 rm) (rmCommitted_17 rm)))
    (forall ((rm RM)) (= (rmAborted_18 rm) (rmAborted_17 rm)))
...
(assert (=> (= action_18 RMPrepare)
    (exists ((rm RM)) (and
        ...
        (forall ((rm2 RM))
            (or
              (= rm rm2)
              (= (rmWorking_18 rm2) (rmWorking_17 rm2)))
            ) ;;;
        (rmPrepared_18 rm)
        (forall ((rm2 RM))
            (or
              (= rm rm2)
              (= (rmPrepared_18 rm2) (rmPrepared_17 rm2)))
            ) ;;;
        (forall ((rm2 RM))
            (or
              (= rm rm2)
              (= (sentPrepared_18 rm2) (sentPrepared_17 rm2)))
            ) ;;;
        (forall ((rm2 RM)) (= (rmCommitted_18 rm2) (rmCommitted_17 rm2)))
        (forall ((rm2 RM)) (= (rmAborted_18 rm2) (rmAborted_17 rm2)))
        (= tmState_18 tmState_17)
)))) ;;;

(assert (=> (= action_18 RMChooseToAbort)
    (exists ((rm RM)) (and
        (rmWorking_17 rm)
        (not (rmWorking_18 rm))
        (forall ((rm2 RM))
        ...
        (forall ((rm2 RM))
            (or
              (= rm rm2)
              (= (rmAborted_18 rm2) (rmAborted_17 rm2)))
            ) ;;;
        (forall ((rm2 RM)) (= (rmCommitted_18 rm2) (rmCommitted_17 rm2)))
        (forall ((rm2 RM)) (= (sentPrepared_18 rm2) (sentPrepared_17 rm2)))
        (= tmState_18 tmState_17)
)))) ;;;

(assert (=> (= action_18 RMRcvCommitMsg)
    (exists ((rm RM)) (and
        (= tmState_17 TMcommitted)
        (not (rmWorking_18 rm))
        (forall ((rm2 RM))
        ...
        (forall ((rm2 RM))
            (or
              (= rm rm2)
              (= (rmCommitted_18 rm2) (rmCommitted_17 rm2)))
            ) ;;;
        (not (rmAborted_18 rm))
        (forall ((rm2 RM))
            (or
...
(assert (=> (= action_18 RMRcvAbortMsg)
    (exists ((rm RM)) (and
        (= tmState_17 TMaborted)
        (not (rmWorking_18 rm))
        (forall ((rm2 RM))
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; frame 19
(declare-fun rmWorking_19 (RM) Bool)
(declare-fun rmPrepared_19 (RM) Bool)
(declare-fun rmCommitted_19 (RM) Bool)
(declare-fun rmAborted_19 (RM) Bool)
(declare-fun sentPrepared_19 (RM) Bool)
(declare-fun tmState_19 () TMState)

(declare-fun action_19 () Action)

; actions for frame 19
(assert (=> (= action_19 TMRcvPrepared) (and
    (= tmState_18 TMinit)
    ;; the line below gives us unknown:
    ;;(= rmWorking_19 rmWorking_18)
    (forall ((rm RM)) (= (rmWorking_19 rm) (rmWorking_18 rm)))
    (forall ((rm RM)) (= (rmPrepared_19 rm) (rmPrepared_18 rm)))
    (forall ((rm RM)) (= (rmCommitted_19 rm) (rmCommitted_18 rm)))
    (forall ((rm RM)) (= (rmAborted_19 rm) (rmAborted_18 rm)))
    (forall ((rm RM)) (= (sentPrepared_19 rm) (sentPrepared_18 rm)))
    (= tmState_19 tmState_18)
))) ;;;

(assert (=> (= action_19 TMCommit) (and
    (= tmState_18 TMinit)
    (forall ((rm RM)) (sentPrepared_18 rm))
    (= tmState_19 TMcommitted)
    (forall ((rm RM)) (= (rmWorking_19 rm) (rmWorking_18 rm)))
    (forall ((rm RM)) (= (rmPrepared_19 rm) (rmPrepared_18 rm)))
    (forall ((rm RM)) (= (rmCommitted_19 rm) (rmCommitted_18 rm)))
    (forall ((rm RM)) (= (rmAborted_19 rm) (rmAborted_18 rm)))
...
(assert (=> (= action_19 TMAbort) (and
    (= tmState_18 TMinit)
    (= tmState_19 TMaborted)
    (forall ((rm RM)) (= (rmWorking_19 rm) (rmWorking_18 rm)))
    (forall ((rm RM)) (= (rmPrepared_19 rm) (rmPrepared_18 rm)))
    (forall ((rm RM)) (= (rmCommitted_19 rm) (rmCommitted_18 rm)))
    (forall ((rm RM)) (= (rmAborted_19 rm) (rmAborted_18 rm)))
...
(assert (=> (= action_19 RMPrepare)
    (exists ((rm RM)) (and
        ...
        (forall ((rm2 RM))
            (or
              (= rm rm2)
              (= (rmWorking_19 rm2) (rmWorking_18 rm2)))
            ) ;;;
        (rmPrepared_19 rm)
        (forall ((rm2 RM))
            (or
              (= rm rm2)
              (= (rmPrepared_19 rm2) (rmPrepared_18 rm2)))
            ) ;;;
        (forall ((rm2 RM))
            (or
              (= rm rm2)
              (= (sentPrepared_19 rm2) (sentPrepared_18 rm2)))
            ) ;;;
        (forall ((rm2 RM)) (= (rmCommitted_19 rm2) (rmCommitted_18 rm2)))
        (forall ((rm2 RM)) (= (rmAborted_19 rm2) (rmAborted_18 rm2)))
        (= tmState_19 tmState_18)
)))) ;;;

(assert (=> (= action_19 RMChooseToAbort)
    (exists ((rm RM)) (and
        (rmWorking_18 rm)
        (not (rmWorking_19 rm))
        (forall ((rm2 RM))
        ...
        (forall ((rm2 RM))
            (or
              (= rm rm2)
              (= (rmAborted_19 rm2) (rmAborted_18 rm2)))
            ) ;;;
        (forall ((rm2 RM)) (= (rmCommitted_19 rm2) (rmCommitted_18 rm2)))
        (forall ((rm2 RM)) (= (sentPrepared_19 rm2) (sentPrepared_18 rm2)))
        (= tmState_19 tmState_18)
)))) ;;;

(assert (=> (= action_19 RMRcvCommitMsg)
    (exists ((rm RM)) (and
        (= tmState_18 TMcommitted)
        (not (rmWorking_19 rm))
        (forall ((rm2 RM))
        ...
        (forall ((rm2 RM))
            (or
              (= rm rm2)
              (= (rmCommitted_19 rm2) (rmCommitted_18 rm2)))
            ) ;;;
        (not (rmAborted_19 rm))
        (forall ((rm2 RM))
            (or
...
(assert (=> (= action_19 RMRcvAbortMsg)
    (exists ((rm RM)) (and
        (= tmState_18 TMaborted)
        (not (rmWorking_19 rm))
        (forall ((rm2 RM))
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; frame 20
(declare-fun rmWorking_20 (RM) Bool)
(declare-fun rmPrepared_20 (RM) Bool)
(declare-fun rmCommitted_20 (RM) Bool)
(declare-fun rmAborted_20 (RM) Bool)
(declare-fun sentPrepared_20 (RM) Bool)
(declare-fun tmState_20 () TMState)

(declare-fun action_20 () Action)

; actions for frame 20
(assert (=> (= action_20 TMRcvPrepared) (and
    (= tmState_19 TMinit)
    ;; the line below gives us unknown:
    ;;(= rmWorking_20 rmWorking_19)
    (forall ((rm RM)) (= (rmWorking_20 rm) (rmWorking_19 rm)))
    (forall ((rm RM)) (= (rmPrepared_20 rm) (rmPrepared_19 rm)))
    (forall ((rm RM)) (= (rmCommitted_20 rm) (rmCommitted_19 rm)))
    (forall ((rm RM)) (= (rmAborted_20 rm) (rmAborted_19 rm)))
    (forall ((rm RM)) (= (sentPrepared_20 rm) (sentPrepared_19 rm)))
    (= tmState_20 tmState_19)
))) ;;;

(assert (=> (= action_20 TMCommit) (and
    (= tmState_19 TMinit)
    (forall ((rm RM)) (sentPrepared_19 rm))
    (= tmState_20 TMcommitted)
    (forall ((rm RM)) (= (rmWorking_20 rm) (rmWorking_19 rm)))
    (forall ((rm RM)) (= (rmPrepared_20 rm) (rmPrepared_19 rm)))
    (forall ((rm RM)) (= (rmCommitted_20 rm) (rmCommitted_19 rm)))
    (forall ((rm RM)) (= (rmAborted_20 rm) (rmAborted_19 rm)))
...
(assert (=> (= action_20 TMAbort) (and
    (= tmState_19 TMinit)
    (= tmState_20 TMaborted)
    (forall ((rm RM)) (= (rmWorking_20 rm) (rmWorking_19 rm)))
    (forall ((rm RM)) (= (rmPrepared_20 rm) (rmPrepared_19 rm)))
    (forall ((rm RM)) (= (rmCommitted_20 rm) (rmCommitted_19 rm)))
    (forall ((rm RM)) (= (rmAborted_20 rm) (rmAborted_19 rm)))
...
(assert (=> (= action_20 RMPrepare)
    (exists ((rm RM)) (and
        ...
        (forall ((rm2 RM))
            (or
              (= rm rm2)
              (= (rmWorking_20 rm2) (rmWorking_19 rm2)))
            ) ;;;
        (rmPrepared_20 rm)
        (forall ((rm2 RM))
            (or
              (= rm rm2)
              (= (rmPrepared_20 rm2) (rmPrepared_19 rm2)))
            ) ;;;
        (forall ((rm2 RM))
            (or
              (= rm rm2)
              (= (sentPrepared_20 rm2) (sentPrepared_19 rm2)))
            ) ;;;
        (forall ((rm2 RM)) (= (rmCommitted_20 rm2) (rmCommitted_19 rm2)))
        (forall ((rm2 RM)) (= (rmAborted_20 rm2) (rmAborted_19 rm2)))
        (= tmState_20 tmState_19)
)))) ;;;

(assert (=> (= action_20 RMChooseToAbort)
    (exists ((rm RM)) (and
        (rmWorking_19 rm)
        (not (rmWorking_20 rm))
        (forall ((rm2 RM))
        ...
        (forall ((rm2 RM))
            (or
              (= rm rm2)
              (= (rmAborted_20 rm2) (rmAborted_19 rm2)))
            ) ;;;
        (forall ((rm2 RM)) (= (rmCommitted_20 rm2) (rmCommitted_19 rm2)))
        (forall ((rm2 RM)) (= (sentPrepared_20 rm2) (sentPrepared_19 rm2)))
        (= tmState_20 tmState_19)
)))) ;;;

(assert (=> (= action_20 RMRcvCommitMsg)
    (exists ((rm RM)) (and
        (= tmState_19 TMcommitted)
        (not (rmWorking_20 rm))
        (forall ((rm2 RM))
        ...
        (forall ((rm2 RM))
            (or
              (= rm rm2)
              (= (rmCommitted_20 rm2) (rmCommitted_19 rm2)))
            ) ;;;
        (not (rmAborted_20 rm))
        (forall ((rm2 RM))
            (or
...
(assert (=> (= action_20 RMRcvAbortMsg)
    (exists ((rm RM)) (and
        (= tmState_19 TMaborted)
        (not (rmWorking_20 rm))
        (forall ((rm2 RM))
...
(assert (or
    ...
    (exists ((rm1 RM) (rm2 RM))
        (and (rmAborted_16 rm1) (rmCommitted_16 rm2 )))
    (exists ((rm1 RM) (rm2 RM))
        (and (rmAborted_17 rm1) (rmCommitted_17 rm2 )))
    (exists ((rm1 RM) (rm2 RM))
        (and (rmAborted_18 rm1) (rmCommitted_18 rm2 )))
    (exists ((rm1 RM) (rm2 RM))
        (and (rmAborted_19 rm1) (rmCommitted_19 rm2 )))
    (exists ((rm1 RM) (rm2 RM))
        (and (rmAborted_20 rm1) (rmCommitted_20 rm2 )))
)) ;;;
