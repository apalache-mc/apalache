...
/**
 * This is trait that allows one to associate a text message with an integer id. The main usage is to associate error
 * messages with the Boolean flags that specify assertion violations.
 *
 * @author
 *   Igor Konnov
 */
