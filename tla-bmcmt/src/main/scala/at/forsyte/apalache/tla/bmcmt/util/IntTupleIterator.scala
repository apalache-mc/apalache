...
/**
 * Iterate over all k-tuples from (0,...,0) up to (n_1, ..., n_k), including the tuple (n_1, ..., n_k). This iterator is
 * useful to construct Cartesian products that are needed by multiple argument operators.
 *
 * @author
 *   Igor Konnov
 */
