 ...
 * (Arena). As a by-product, it produces SMT constraints on the graph.</p>
 *
 * <p>This is the central access point for the rewriting rules. So it exposes many caches and storages.</p>
 *
 * <p>This trait implements StackableContext by delegating the respective operations to the caches and the SMT
 * context.</p>
 *
