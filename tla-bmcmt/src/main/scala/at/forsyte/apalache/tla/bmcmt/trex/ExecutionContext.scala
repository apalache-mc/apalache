...
/**
 * A context that is used by TransitionExecutor. By default, a context is not thread-safe, that is, you should have one
 * context per thread. IncrementalExecutorContext is the simplest implementation.
 *
 * @author
 *   Igor Konnov
 */
