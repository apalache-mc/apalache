...
package object bmcmt {
  ...
  sealed abstract class Theory {
     ...
     *   a constant name
     * @return
     *   if the name follows the naming conventions of this theory.
     */
     ...
     *   a TLA expression
     * @return
     *   true, if tlaEx is NameEx(name) and name is a name of a theory constant.
     */
    ...
    /**
     * Check, whether a TLA expression is NameEx and a theory constant. If so, return its name.
     *
     * @param tlaEx
     *   a TLA expression
     * @return
     ...
     *   if the expression is not a theory constant
     */
