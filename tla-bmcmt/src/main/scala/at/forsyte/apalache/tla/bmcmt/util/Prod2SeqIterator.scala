...
/**
 * An iterator over the elements of a Cartesian product of two sequences. This implementation is not quite optimal, as
 * it accesses two elements by index at each iteration.
 *
 * @tparam T1
