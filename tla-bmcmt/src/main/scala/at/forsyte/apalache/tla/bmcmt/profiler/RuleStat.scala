...
class RuleStat(val ruleName: String) {
  ...
  /**
   * The total length of SMT assertions that are made by the rule itself. The division smtAssertsLenTotal /
   * nSmtAssertsSelf gives us the average length of clauses.
   */
