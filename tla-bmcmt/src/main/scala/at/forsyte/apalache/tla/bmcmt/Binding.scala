...
/**
 * Binding variables to memory cells. We keep the number of methods to minimum. If you need all the Map methods, use
 * toMap and convert the result with Binding(...).
 */
