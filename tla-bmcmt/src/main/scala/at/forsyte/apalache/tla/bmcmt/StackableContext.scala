...
/**
 * A context whose state can be saved on the stack by push and later restored by pop, similar to an SMT context. This
 * trait is used for: SMT contexts and value caches.
 *
 * @author
 *   Igor Konnov
 */
