...
class TestSeqModelCheckerWithCvc5FunArrays extends TestSeqModelCheckerTrait {
  override protected def withFixture(test: OneArgTest): Outcome = {
    val solver = RecordingSolverContext.create(None,
        SolverConfig.default.copy(smtEncoding = SMTEncoding.FunArrays, smtSolver = SMTSolver.CVC5, z3StatsSec = 0))
