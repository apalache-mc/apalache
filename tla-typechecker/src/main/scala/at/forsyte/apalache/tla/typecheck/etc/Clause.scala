 ...
 * operators overloading. Thus, our constraints admit disjunctions.
 */
 ...
 *
 * @param unknown
 *   a variable in the left-hand side of the equation
 * @param term
 *   a type in the right-hand side of the equation
 */
case class EqClause(unknown: VarT1, term: TlaType1) extends Clause

/**
 * A disjunctive clause: one of the argument equations should hold true. Such a clause is produced by an overloaded TLA+
 * operator.
 *
 * @param clauses
 *   the clauses to choose from.
 */
