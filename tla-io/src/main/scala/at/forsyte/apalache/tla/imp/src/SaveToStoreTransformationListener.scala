...
/**
 * <p>This is a special form of transformation tracker that records the changes directly in the source store. In
 * general, this behavior is discouraged. However, when SanyImporter does code modifications itself, it can only save
 * the changes in the source store. Do not use this class outside of SanyImporter.</p>
 *
