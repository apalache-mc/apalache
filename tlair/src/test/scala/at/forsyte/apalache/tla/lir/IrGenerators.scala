...
trait IrGenerators extends TlaType1Gen {
  ...
  val functionOperators =
    List(TlaFunOper.enum, TlaFunOper.tuple, TlaFunOper.app, TlaFunOper.domain, TlaFunOper.recFunDef, TlaFunOper.recFunRef,
        TlaFunOper.except)
  /* TlaFunOper.funDef seems to cause lots of malformed expressions; disable it for now.
