...
class TestModule extends FunSuite {
  test("AlternatingBit module from Lamport's book") {
    ...
    /** Constants {0,1} and <<>> */
    val ZeroOneSet =
      OperEx(TlaSetOper.enumSet, ValEx(TlaInt(0)), ValEx(TlaInt(1)))
      ...
      new TlaOperDecl(
        ...
        OperEx(
          ...
          OperEx(
            ...
            OperEx(
              TlaSetOper.seqSet,
              OperEx(TlaSetOper.times, ZeroOneSet, NameEx("Data"))
            )
          ),
          OperEx(
            TlaSetOper.in,
            NameEx("ackQ"),
            OperEx(TlaSetOper.seqSet, ZeroOneSet)
          ),
          OperEx(TlaSetOper.in, NameEx("sBit"), ZeroOneSet),
    ...
    val SndNewValue =
      new TlaOperDecl(
        ...
        OperEx(
          ...
          OperEx(
            TlaOper.eq,
            OperEx(TlaActionOper.prime, NameEx("sent")),
            NameEx("d")
          ),
          OperEx(
            TlaOper.eq,
            OperEx(TlaActionOper.prime, NameEx("sBit")),
            OperEx(TlaArithOper.minus, ValEx(TlaInt(1)), NameEx("sBit"))
          ),
          OperEx(
            TlaOper.eq,
            OperEx(TlaActionOper.prime, NameEx("msgQ")),
            OperEx(
              TlaSeqOper.append,
              NameEx("msgQ"),
              OperEx(
    ...
    val ReSndMsg =
      new TlaOperDecl(
        ...
        OperEx(
          TlaBoolOper.and,
          OperEx(TlaOper.ne, NameEx("sAck"), NameEx("sBit")),
          OperEx(
            TlaOper.eq,
            OperEx(TlaActionOper.prime, NameEx("msgQ")),
            OperEx(
              TlaSeqOper.append,
              NameEx("msgQ"),
              OperEx(TlaFunOper.tuple, NameEx("sBit"), NameEx("sent"))
            )
          ),
          OperEx(
            TlaActionOper.unchanged,
      ...
      new TlaOperDecl(
        ...
        OperEx(
          ...
          OperEx(
            TlaOper.eq,
            OperEx(TlaActionOper.prime, NameEx("msgQ")),
            OperEx(TlaSeqOper.tail, NameEx("msgQ"))
          ),
          OperEx(
            TlaOper.eq,
            OperEx(TlaActionOper.prime, NameEx("rBit")),
            OperEx(
              TlaFunOper.app,
              OperEx(TlaSeqOper.head, NameEx("msgQ")),
              ValEx(TlaInt(1))
            )
          ),
          OperEx(
            TlaOper.eq,
            OperEx(TlaActionOper.prime, NameEx("rcvd")),
            OperEx(
              TlaFunOper.app,
              OperEx(TlaSeqOper.head, NameEx("msgQ")),
              ValEx(TlaInt(2))
    ...
    val SndAck =
      new TlaOperDecl(
        ...
        OperEx(
          ...
          OperEx(
            TlaOper.eq,
            OperEx(TlaActionOper.prime, NameEx("ackQ")),
      ...
      new TlaOperDecl(
        ...
        OperEx(
          ...
          OperEx(
            TlaOper.eq,
            OperEx(TlaActionOper.prime, NameEx("ackQ")),
            OperEx(TlaSeqOper.tail, NameEx("ackQ"))
          ),
          OperEx(
            TlaOper.eq,
            OperEx(TlaActionOper.prime, NameEx("sAck")),
            OperEx(TlaSeqOper.head, NameEx("ackQ"))
          ),
          OperEx(
            TlaActionOper.unchanged,
            OperEx(
      ...
      new TlaOperDecl(
        ...
        OperEx(
          ...
          OperEx(
            TlaArithOper.dotdot,
            ValEx(TlaInt(1)),
            OperEx(TlaSeqOper.len, NameEx("q"))
          ),
          OperEx(
            TlaOper.eq,
            OperEx(TlaActionOper.prime, NameEx("q")),
            OperEx(
              TlaFunOper.funDef,
              NameEx("j"),
              OperEx(
              ...
              OperEx(
                ...
                OperEx(TlaArithOper.lt, NameEx("j"), NameEx("i")),
    ...
    val LoseMsg =
      new TlaOperDecl(
        ...
        OperEx(
          TlaBoolOper.and,
          OperEx(TlaOper.apply, NameEx("Lose"), NameEx("msgQ")),
    ...
    val LoseAck =
      new TlaOperDecl(
        ...
        OperEx(
          TlaBoolOper.and,
          OperEx(TlaOper.apply, NameEx("Lose"), NameEx("ackQ")),
    ...
    val abvars =
      new TlaOperDecl(
        "abvars", // NOTE: Is this really an operator? Seems contrived.
        List(),
        OperEx(
          TlaFunOper.tuple,
          NameEx("msgQ"),
    ...
    val ABSpec =
      new TlaOperDecl(
        ...
        OperEx(
          TlaBoolOper.and,
          NameEx("ABInit"),
          OperEx(TlaActionOper.stutter, NameEx("ABNext"), NameEx("abvars")),
          NameEx("ABFairness")
        )
      )
