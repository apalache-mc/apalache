...
/**
 * <p>This is a temporary kludge to support migration from TLC's :> and @@. Do not use it in the new code. This will be
 * fixed in: https://github.com/informalsystems/apalache/issues/1226</p>
 *
