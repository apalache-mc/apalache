 ...
 * Higher-order operators have at least one parameter that is an operator itself. We declare `OperParam` as a case
 * class, in order to have `equals` and pattern-matching.
 */
